class pr002 {
	public static void main(String args[]) {
		...
		int i11;
		b11 = 10;
		i11 = b11 * b11; //При операции перемножения двух переменных типов bute получается повышение результата до типа int

		b11 = 10;
		b11 = (bute)( b11 * b11); // Необходимо приведение типа int к типу bute

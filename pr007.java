...
//Класс для вызова метода с епередачей пареметров по ссылке
class CallByRef {
	int a12, b12;
...
//Возврат объекта определённогго в программе
class Err {
	String msg; //Сообщение об ошибки
...
class pr007 {
	public static void main(String[] args) {
		...
		//Пример использования методов классов с параметром в виде объектов (Класс Block)
		System.out.println();
		...
		//При передачи параметров методу объекта по значению, значение аргументов не изменяются
